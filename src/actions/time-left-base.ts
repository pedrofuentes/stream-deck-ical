/**
 * TimeLeftActionBase - decorator-free display/business logic for TimeLeftAction.
 *
 * All of TimeLeftAction's behavior lives here so it can be imported directly by
 * vitest (the @action-decorated leaf class throws SyntaxError under vitest's
 * esbuild transform). The decorated leaf in time-left.ts is a thin subclass that
...
/**
 * TimeLeftActionBase - holds all TimeLeftAction logic (decorator-free)
 */
export class TimeLeftActionBase extends BaseAction {
